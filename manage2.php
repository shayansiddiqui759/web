...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['update_status'])) {
        ...
        echo "<script>showPopup('EOI status updated successfully.');</script>";
    } elseif (isset($_POST['delete_eoi'])) {
        // Delete EOIs
        deleteEOIsByJobRef($conn, $_POST['job_ref_to_delete']);
        
        // Show success message
        echo "<script>showPopup('EOIs deleted successfully.');</script>";
...
<body>
    ...
    <div id="popup" class="popup">
        <span class="popup-content" id="popup-content"></span>
        <span class="popup-close" id="popup-close" onclick="closePopup()">&times;</span>
    </div>

    <script>
        // JavaScript code for displaying and closing the pop-up
